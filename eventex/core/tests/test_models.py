...
class SpeakerModelTest(TestCase):
    ...
    def test_unicode(self):
        'Speaker string representation should be de name.'
...
class ContactModelTest(TestCase):
    ...
    def test_phone(self):
        contact = Contact.objects.create(speaker=self.speaker, kind='P', value='21-999554433')
        self.assertEqual(1, contact.pk)
        
    def test_fax(self):
        contact = Contact.objects.create(speaker=self.speaker, kind='F', value='21-34567890')
        self.assertEqual(1, contact.pk)
    ...
    def test_unicode(self):
        'Contact string representation should be de value.'
